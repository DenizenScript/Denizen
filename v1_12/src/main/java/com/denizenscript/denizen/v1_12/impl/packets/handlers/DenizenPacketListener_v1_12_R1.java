...
import com.denizenscript.denizen.v1_12.impl.packets.PacketInResourcePackStatus_v1_12_R1;
import com.denizenscript.denizen.v1_12.impl.packets.PacketInSteerVehicle_v1_12_R1;
...
public class DenizenPacketListener_v1_12_R1 extends AbstractListenerPlayIn_v1_12_R1 {

    private static PacketHandler packetHandler;

    public DenizenPacketListener_v1_12_R1(NetworkManager networkManager, EntityPlayer entityPlayer) {
    ...
    public void a(final PacketPlayInSteerVehicle packet) {
        if (!packetHandler.receivePacket(player.getBukkitEntity(), new PacketInSteerVehicle_v1_12_R1(packet))) {
            super.a(packet);
        }
    }
    ...
    public void a(PacketPlayInResourcePackStatus packet) {
        packetHandler.receivePacket(player.getBukkitEntity(), new PacketInResourcePackStatus_v1_12_R1(packet));
        super.a(packet);
    }
    ...
    public static class PlayerEventListener implements Listener {
        ...
        public void onPlayerJoin(PlayerJoinEvent event) {
            DenizenNetworkManager_v1_12_R1.setNetworkManager(event.getPlayer(), packetHandler);
        }
    }
}

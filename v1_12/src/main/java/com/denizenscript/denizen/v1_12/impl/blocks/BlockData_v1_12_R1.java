...
public class BlockData_v1_12_R1 implements BlockData {
    ...
    public BlockData_v1_12_R1(Block block) {
        ...
        if (te != null) {
            ...
            te.save(compound);
            ctag = (CompoundTag_v1_12_R1) CompoundTag_v1_12_R1.fromNMSTag(compound);
        }
    }
    ...
    public void setBlock(Block block, boolean physics) {
        ...
        if (ctag != null) {
            ...
            ctag = (CompoundTag_v1_12_R1) builder.build();
            // TODO: make this work!
    ...
    public static BlockData fromCompressedString(String str) {
        BlockData data = new BlockData_v1_12_R1();

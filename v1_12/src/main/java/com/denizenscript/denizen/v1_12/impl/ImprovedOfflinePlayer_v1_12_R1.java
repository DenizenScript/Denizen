...
import com.denizenscript.denizen.v1_12.impl.jnbt.CompoundTag_v1_12_R1;
...
public class ImprovedOfflinePlayer_v1_12_R1 extends ImprovedOfflinePlayer {

    public ImprovedOfflinePlayer_v1_12_R1(UUID playeruuid) {
        super(playeruuid);
    }
    ...
    public org.bukkit.inventory.PlayerInventory getInventory() {
        ...
        inventory.b(((CompoundTag_v1_12_R1) this.compound).toNMSTag().getList("Inventory", 10));
    ...
    public void setInventory(org.bukkit.inventory.PlayerInventory inventory) {
        ...
        NBTTagCompound nbtTagCompound = ((CompoundTag_v1_12_R1) compound).toNMSTag();
        nbtTagCompound.set("Inventory", inv.getInventory().a(new NBTTagList()));
        this.compound = CompoundTag_v1_12_R1.fromNMSTag(nbtTagCompound);
        if (this.autosave) {
            savePlayerData();
        }
    }
    ...
    public Inventory getEnderChest() {
        ...
        endchest.a(((CompoundTag_v1_12_R1) this.compound).toNMSTag().getList("EnderItems", 10));
    ...
    private AttributeMapBase getAttributes() {
        ...
        initAttributes(amb);
        GenericAttributes.a(amb, ((CompoundTag_v1_12_R1) this.compound).toNMSTag().getList("Attributes", 10));
        return amb;
    }
    ...
    protected boolean loadPlayerData(UUID uuid) {
        try {
            ...
            for (org.bukkit.World w : Bukkit.getWorlds()) {
                ...
                if (this.file.exists()) {
                    this.compound = CompoundTag_v1_12_R1.fromNMSTag(NBTCompressedStreamTools.a(new FileInputStream(this.file)));
                    return true;
                }
            }
        }
    ...
    public void savePlayerData() {
        if (this.exists) {
            try {
                NBTCompressedStreamTools.a(((CompoundTag_v1_12_R1) this.compound).toNMSTag(), new FileOutputStream(this.file));
            }
            catch (Exception e) {
                Debug.echoError(e);
            }

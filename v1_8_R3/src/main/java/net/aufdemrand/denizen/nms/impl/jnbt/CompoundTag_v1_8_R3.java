...
public class CompoundTag_v1_8_R3 extends CompoundTag {
    ...
    public NBTTagCompound toNMSTag() {
        ...
        for (Map.Entry<String, Tag> entry: value.entrySet()) {
            if (entry.getValue() instanceof IntTag) {
                ...
                tag.set(entry.getKey(), ((CompoundTag_v1_8_R3) entry.getValue()).toNMSTag());
            }
                ...
                for (Tag btag : tags) {
                    ...
                    btags.put("test", btag);
                    CompoundTag_v1_8_R3 comp = new CompoundTag_v1_8_R3(btags);
    ...
    public static CompoundTag fromNMSTag(NBTTagCompound tag) {
        ...
        return new CompoundTag_v1_8_R3(tags);
    }
}

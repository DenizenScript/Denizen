...
import net.aufdemrand.denizen.nms.impl.packets.handlers.DenizenPacketListener_v1_8_R3;
...
public class Handler_v1_8_R3 extends NMSHandler {
    ...
    private final WorldHelper worldHelper = new WorldHelper_v1_8_R3();
    ...
    public void enablePacketInterception(PacketHandler packetHandler) {
        DenizenPacketListener_v1_8_R3.enable(packetHandler);
    }

    @Override
    public CompoundTag createCompoundTag(Map<String, Tag> value) {
        return new CompoundTag_v1_8_R3(value);
    }

    @Override
    public Sidebar createSidebar(Player player) {
        return new Sidebar_v1_8_R3(player);
    }

    @Override
    public BlockLight createBlockLight(Location location, int lightLevel, long ticks) {
        return BlockLight_v1_8_R3.createLight(location, lightLevel, ticks);
    }

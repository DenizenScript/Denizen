    ...
    public PacketOutTradeList_v1_8_R3(PacketPlayOutCustomPayload internal) {
        ...
        try {
            ...
            for (byte i = 0; i < tradeCount; i++) {
                ItemStack firstCost = CraftItemStack.asBukkitCopy(serializer.i());
                ItemStack product = CraftItemStack.asBukkitCopy(serializer.i());
                boolean hasSecondCost = serializer.readBoolean();
                ItemStack secondCost = hasSecondCost ? CraftItemStack.asBukkitCopy(serializer.i()) : null;

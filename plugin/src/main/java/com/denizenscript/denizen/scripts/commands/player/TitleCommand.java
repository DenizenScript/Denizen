...
public class TitleCommand extends AbstractCommand {
    ...
    public static void autoExecute(ScriptEntry scriptEntry,
        ...
        ParseableTag parseableSubTitle = strSubTitle == null ? null : TagManager.parseTextToTag(strSubTitle, context);
    ...
    public static String parse(ParseableTag tag, BukkitTagContext context) {
        return tag == null ? null : tag.parse(context).asElement().asString();
    }
}

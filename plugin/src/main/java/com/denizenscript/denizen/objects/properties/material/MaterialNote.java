...
public class MaterialNote implements Property {
    ...
    public static void registerTags() {
        ...
        // -->
        PropertyParser.<MaterialNote>registerTag("note_octave", (attribute, material) -> {
        ...
        // Like A or A#.
        // -->
        PropertyParser.<MaterialNote>registerTag("note_tone", (attribute, material) -> {
        ...
        // -->
        PropertyParser.<MaterialNote>registerTag("note", (attribute, material) -> {

...
public class PropertyRegistry {
    ...
    public static void registermainProperties() {
        ...
        if (NMSHandler.getVersion().isAtLeast(NMSVersion.v1_13)) {
            ...
            PropertyParser.registerProperty(MaterialDisarmed.class, MaterialTag.class);
            PropertyParser.registerProperty(MaterialDrags.class, MaterialTag.class);
            PropertyParser.registerProperty(MaterialEye.class, MaterialTag.class);
            ...
            PropertyParser.registerProperty(MaterialHanging.class, MaterialTag.class);
            PropertyParser.registerProperty(MaterialInstrument.class, MaterialTag.class);
            PropertyParser.registerProperty(MaterialInverted.class, MaterialTag.class);
            PropertyParser.registerProperty(MaterialIsInWall.class, MaterialTag.class);
            if (NMSHandler.getVersion().isAtLeast(NMSVersion.v1_14)) {

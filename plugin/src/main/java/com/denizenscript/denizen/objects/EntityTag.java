...
public class EntityTag implements ObjectTag, Adjustable, EntityFormObject, FlaggableObject, Cloneable {
    ...
    public static void register() {
        ...
        if (NMSHandler.getVersion().isAtLeast(NMSVersion.v1_19)) {
            ...
            // - 'time' (TimeTag): the time the interaction occurred at. Note that this value is calculated, and may become inaccurate if the interaction entity changes worlds or the server lags.

...
public class BukkitCommandRegistry extends CommandRegistry {
    ...
    public void registerCoreMembers() {
        ...
        // <--[command]
        // @Name Take
        // @Syntax take [money/iteminhand/scriptname:<scriptname>/bydisplay:<name>/bycover:<title>|<author>/slot:<#>/<item>|...] (quantity:<#>) (from:<inventory>)
        // @Required 1
        // @Stable stable
        ...
        // @Usage
        // Use to take an MyFancyDiamond from the player's inventory
        // - take scriptname:MyFancyDiamond
        // -->

...
public class PacketHelperImpl implements PacketHelper {
    ...
    static {
        try {
            ENTITY_CUSTOM_NAME_METADATA = ReflectionHelper.getFieldValue(net.minecraft.server.v1_14_R1.Entity.class, "az", null);
            ENTITY_CUSTOM_NAME_VISIBLE_METADATA = ReflectionHelper.getFieldValue(net.minecraft.server.v1_14_R1.Entity.class, "aA", null);
        }
        catch (Throwable ex) {
            ex.printStackTrace();
        }

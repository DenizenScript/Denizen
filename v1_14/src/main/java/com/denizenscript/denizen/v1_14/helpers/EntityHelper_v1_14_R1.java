...
import com.denizenscript.denizen.v1_14.impl.blocks.BlockData_v1_14_R1;
import com.denizenscript.denizen.v1_14.impl.jnbt.CompoundTag_v1_14_R1;
...
public class EntityHelper_v1_14_R1 extends EntityHelper {
    ...
    public CompoundTag getNbtData(Entity entity) {
        ...
        return CompoundTag_v1_14_R1.fromNMSTag(compound);
    }

    @Override
    public void setNbtData(Entity entity, CompoundTag compoundTag) {
        ((CraftEntity) entity).getHandle().f(((CompoundTag_v1_14_R1) compoundTag).toNMSTag());
    }
    ...
    public BlockData getBlockDataFor(FallingBlock entity) {
        return new BlockData_v1_14_R1(entity.getBlockData());
    }
}

package com.denizenscript.denizen.v1_14.impl.jnbt;
...
public class CompoundTag_v1_14_R1 extends CompoundTag {
    ...
    public NBTTagCompound toNMSTag() {
        ...
        for (Map.Entry<String, Tag> entry : value.entrySet()) {
            if (entry.getValue() instanceof IntTag) {
                ...
                tag.set(entry.getKey(), ((CompoundTag_v1_14_R1) entry.getValue()).toNMSTag());
            }
    ...
    public static CompoundTag fromNMSTag(NBTTagCompound tag) {
        ...
        return new CompoundTag_v1_14_R1(tags);
    }
}

...
public class CraftItemProjectile_v1_14_R1 extends CraftItem implements ItemProjectile {
    ...
    public CraftItemProjectile_v1_14_R1(CraftServer server, EntityItemProjectile_v1_14_R1 entity) {
        super(server, entity);
    }
    ...
    @Override
    public EntityItemProjectile_v1_14_R1 getHandle() {
        return (EntityItemProjectile_v1_14_R1) super.getHandle();
    }

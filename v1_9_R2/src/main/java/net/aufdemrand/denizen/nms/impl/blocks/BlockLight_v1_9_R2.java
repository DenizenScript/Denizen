...
public class BlockLight_v1_9_R2 extends BlockLight {
            ...
            public void run() {
                for (Map.Entry<org.bukkit.Chunk, List<BlockLight>> entry : lightsByChunk.entrySet()) {
                    ...
                    if (chunk.isLoaded()) {
                        ...
                        PlayerChunkMap playerChunkMap = ((BlockLight_v1_9_R2) blockLights.get(0)).worldServer.getPlayerChunkMap();
    ...
    private BlockLight_v1_9_R2(Location location, long ticks) {
    ...
    public static BlockLight createLight(Location location, int lightLevel, long ticks) {
        ...
        if (lightsByLocation.containsKey(location)) {
            ...
            blockLight = new BlockLight_v1_9_R2(location, ticks);

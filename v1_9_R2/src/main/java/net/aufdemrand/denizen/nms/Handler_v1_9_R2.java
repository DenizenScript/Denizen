...
import net.aufdemrand.denizen.nms.impl.BiomeNMS_v1_9_R2;
import net.aufdemrand.denizen.nms.impl.ProfileEditor_v1_9_R2;
import net.aufdemrand.denizen.nms.impl.Sidebar_v1_9_R2;
import net.aufdemrand.denizen.nms.impl.blocks.BlockLight_v1_9_R2;
import net.aufdemrand.denizen.nms.impl.jnbt.CompoundTag_v1_9_R2;
import net.aufdemrand.denizen.nms.impl.packets.handlers.DenizenPacketListener_v1_9_R2;
...
public class Handler_v1_9_R2 extends NMSHandler {
    ...
    private final BossBarHelper bossBarHelper = new BossBarHelper_v1_9_R2();
    ...
    private final WorldHelper worldHelper = new WorldHelper_v1_9_R2();
    ...
    public void enablePacketInterception(PacketHandler packetHandler) {
        DenizenPacketListener_v1_9_R2.enable(packetHandler);
    }

    @Override
    public CompoundTag createCompoundTag(Map<String, Tag> value) {
        return new CompoundTag_v1_9_R2(value);
    }

    @Override
    public Sidebar createSidebar(Player player) {
        return new Sidebar_v1_9_R2(player);
    }

    @Override
    public BlockLight createBlockLight(Location location, int lightLevel, long ticks) {
        return BlockLight_v1_9_R2.createLight(location, lightLevel, ticks);
    }
    ...
    public BiomeNMS getBiomeNMS(Biome biome) {
        return new BiomeNMS_v1_9_R2(biome);
    }

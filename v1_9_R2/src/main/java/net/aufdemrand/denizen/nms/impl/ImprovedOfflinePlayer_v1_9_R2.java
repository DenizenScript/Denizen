...
public class ImprovedOfflinePlayer_v1_9_R2 extends ImprovedOfflinePlayer {

    public ImprovedOfflinePlayer_v1_9_R2(UUID playeruuid) {
        super(playeruuid);
    }
    ...
    public org.bukkit.inventory.PlayerInventory getInventory() {
        ...
        inventory.b(((CompoundTag_v1_9_R2) this.compound).toNMSTag().getList("Inventory", 10));
    ...
    protected boolean loadPlayerData(UUID uuid) {
        try {
            ...
            for (org.bukkit.World w : Bukkit.getWorlds()) {
                ...
                if (this.file.exists()) {
                    this.compound = CompoundTag_v1_9_R2.fromNMSTag(NBTCompressedStreamTools.a(new FileInputStream(this.file)));
                    return true;
                }
            }
        }
    ...
    public void savePlayerData() {
        if (this.exists) {
            try {
                NBTCompressedStreamTools.a(((CompoundTag_v1_9_R2) this.compound).toNMSTag(), new FileOutputStream(this.file));
            }
            catch (Exception e) {
                e.printStackTrace();
            }

...
import net.aufdemrand.denizen.nms.impl.packets.PacketOutSetSlot_v1_9_R2;
import net.aufdemrand.denizen.nms.impl.packets.PacketOutSpawnEntity_v1_9_R2;
import net.aufdemrand.denizen.nms.impl.packets.PacketOutTradeList_v1_9_R2;
...
public class DenizenNetworkManager_v1_9_R2 extends NetworkManager {

    private final NetworkManager oldManager;
    private final DenizenPacketListener_v1_9_R2 packetListener;
    private final EntityPlayer player;
    private final PacketHandler packetHandler;

    public DenizenNetworkManager_v1_9_R2(EntityPlayer entityPlayer, NetworkManager oldManager, PacketHandler packetHandler) {
        super(getProtocolDirection(oldManager));
        this.oldManager = oldManager;
        this.channel = oldManager.channel;
        this.packetListener = new DenizenPacketListener_v1_9_R2(this, entityPlayer);
    ...
    public static void setNetworkManager(Player player, PacketHandler packetHandler) {
        ...
        setNetworkManager(playerConnection, new DenizenNetworkManager_v1_9_R2(entityPlayer, playerConnection.networkManager, packetHandler));
    }

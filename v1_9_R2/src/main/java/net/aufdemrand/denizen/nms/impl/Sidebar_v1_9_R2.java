...
public class Sidebar_v1_9_R2 extends Sidebar {
    ...
    public void sendUpdate() {
        PacketHelper_v1_9_R2.sendPacket(player, new PacketPlayOutScoreboardObjective(this.obj1, 0));
        for (int i = 0; i < this.lines.length; i++) {
            ...
            PacketHelper_v1_9_R2.sendPacket(player, new PacketPlayOutScoreboardScore(score));
        }
        PacketHelper_v1_9_R2.sendPacket(player, new PacketPlayOutScoreboardDisplayObjective(1, this.obj1));
        PacketHelper_v1_9_R2.sendPacket(player, new PacketPlayOutScoreboardObjective(this.obj2, 1));

...
public class CraftItemProjectile_v1_9_R2 extends CraftItem implements ItemProjectile {

    private boolean doesBounce;

    public CraftItemProjectile_v1_9_R2(CraftServer server, EntityItemProjectile_v1_9_R2 entity) {
        super(server, entity);
    }
    ...
    @Override
    public EntityItemProjectile_v1_9_R2 getHandle() {
        return (EntityItemProjectile_v1_9_R2) super.getHandle();
    }

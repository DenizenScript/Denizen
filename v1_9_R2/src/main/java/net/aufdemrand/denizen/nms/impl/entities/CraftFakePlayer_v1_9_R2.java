...
public class CraftFakePlayer_v1_9_R2 extends CraftPlayer implements FakePlayer {

    private final CraftServer server;
    public String fullName;

    public CraftFakePlayer_v1_9_R2(CraftServer server, EntityFakePlayer_v1_9_R2 entity) {
        super(server, entity);
        this.server = server;

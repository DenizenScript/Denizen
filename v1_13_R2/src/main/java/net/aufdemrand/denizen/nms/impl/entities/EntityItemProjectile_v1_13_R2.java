...
public class EntityItemProjectile_v1_13_R2 extends EntityItem implements IProjectile {
    ...
    public EntityItemProjectile_v1_13_R2(CraftWorld craftWorld, Location location, org.bukkit.inventory.ItemStack itemStack) {
        super(craftWorld.getHandle());
        bukkitEntity = new CraftItemProjectile_v1_13_R2((CraftServer) Bukkit.getServer(), this);
    ...
    @Override
    public CraftItemProjectile_v1_13_R2 getBukkitEntity() {
        return (CraftItemProjectile_v1_13_R2) bukkitEntity;
    }
}

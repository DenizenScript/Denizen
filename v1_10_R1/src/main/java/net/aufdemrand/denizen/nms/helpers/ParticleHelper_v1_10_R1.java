...
import net.aufdemrand.denizen.nms.impl.effects.Effect_v1_10_R1;
...
public class ParticleHelper_v1_10_R1 extends ParticleHelper {
    ...
    public ParticleHelper_v1_10_R1() {
        ...
        for (Effect effect : Effect.values()) {
            register(effect.name(), new Effect_v1_10_R1(effect));
        }
        register("DRIP_WATER", new Effect_v1_10_R1(Effect.WATERDRIP));
        register("DRIP_LAVA", new Effect_v1_10_R1(Effect.LAVADRIP));

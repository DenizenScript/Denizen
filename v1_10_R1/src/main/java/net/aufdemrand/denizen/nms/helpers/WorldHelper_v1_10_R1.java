...
public class WorldHelper_v1_10_R1 implements WorldHelper {
    ...
    public void removeWorldAccess(World world) {
        ...
        List<IWorldAccess> list = ReflectionHelper.getFieldValue(net.minecraft.server.v1_10_R1.World.class, "u", nmsWorld);
        if (list != null) {

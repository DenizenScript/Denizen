...
public class CompoundTag_v1_10_R1 extends CompoundTag {
     ...
     */
    public CompoundTag_v1_10_R1(Map<String, Tag> value) {
        super(value);
    }
    ...
    public NBTTagCompound toNMSTag() {
        ...
        for (Map.Entry<String, Tag> entry: value.entrySet()) {
            if (entry.getValue() instanceof IntTag) {
                ...
                tag.set(entry.getKey(), ((CompoundTag_v1_10_R1) entry.getValue()).toNMSTag());
            }
                ...
                for (Tag btag : tags) {
                    ...
                    btags.put("test", btag);
                    CompoundTag_v1_10_R1 comp = new CompoundTag_v1_10_R1(btags);
    ...
    public static CompoundTag fromNMSTag(NBTTagCompound tag) {
        ...
        return new CompoundTag_v1_10_R1(tags);
    }
}

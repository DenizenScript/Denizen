...
import net.aufdemrand.denizen.nms.impl.packets.handlers.AbstractListenerPlayIn_v1_10_R1;
...
public class PlayerHelper_v1_10_R1 extends PlayerHelper {

    public static final Field ATTACK_COOLDOWN_TICKS = ReflectionHelper.getFields(EntityLiving.class).get("aF");
    ...
    public int getFlyKickCooldown(Player player) {
        ...
        if (conn instanceof AbstractListenerPlayIn_v1_10_R1) {
            conn = ((AbstractListenerPlayIn_v1_10_R1) conn).oldListener;
        }

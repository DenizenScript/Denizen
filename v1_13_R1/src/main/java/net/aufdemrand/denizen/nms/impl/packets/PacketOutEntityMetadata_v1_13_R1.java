...
public class PacketOutEntityMetadata_v1_13_R1 implements PacketOutEntityMetadata {

    private PacketPlayOutEntityMetadata internal;
    private int entityId;
    private List<DataWatcher.Item<?>> metadata;

    public PacketOutEntityMetadata_v1_13_R1(PacketPlayOutEntityMetadata internal) {

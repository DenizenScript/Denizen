...
public class WorldHelper_v1_13_R1 implements WorldHelper {
    ...
    public void setStatic(World world, boolean isStatic) {
        ...
        ReflectionHelper.setFieldValue(net.minecraft.server.v1_13_R1.World.class, "isClientSide", worldServer, isStatic);
    }
    ...
    public void removeWorldAccess(World world) {
        ...
        List<IWorldAccess> list = ReflectionHelper.getFieldValue(net.minecraft.server.v1_13_R1.World.class, "v", nmsWorld);
        if (list != null) {

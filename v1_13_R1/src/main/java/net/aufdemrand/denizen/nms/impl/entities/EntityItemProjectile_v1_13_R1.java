...
public class EntityItemProjectile_v1_13_R1 extends EntityItem implements IProjectile {
    ...
    public EntityItemProjectile_v1_13_R1(CraftWorld craftWorld, Location location, org.bukkit.inventory.ItemStack itemStack) {
        super(craftWorld.getHandle());
        bukkitEntity = new CraftItemProjectile_v1_13_R1((CraftServer) Bukkit.getServer(), this);
    ...
    @Override
    public CraftItemProjectile_v1_13_R1 getBukkitEntity() {
        return (CraftItemProjectile_v1_13_R1) bukkitEntity;
    }
}

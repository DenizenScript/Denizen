...
public class CraftItemProjectile_v1_13_R1 extends CraftItem implements ItemProjectile {

    private boolean doesBounce;

    public CraftItemProjectile_v1_13_R1(CraftServer server, EntityItemProjectile_v1_13_R1 entity) {
        super(server, entity);
    }
    ...
    @Override
    public EntityItemProjectile_v1_13_R1 getHandle() {
        return (EntityItemProjectile_v1_13_R1) super.getHandle();
    }

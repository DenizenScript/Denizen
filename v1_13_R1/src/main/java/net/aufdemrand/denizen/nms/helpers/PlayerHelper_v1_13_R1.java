...
import net.aufdemrand.denizen.nms.impl.ImprovedOfflinePlayer_v1_13_R1;
import net.aufdemrand.denizen.nms.interfaces.PlayerHelper;
import net.minecraft.server.v1_13_R1.MinecraftServer;
import net.minecraft.server.v1_13_R1.OpList;
import net.minecraft.server.v1_13_R1.OpListEntry;
...
public class PlayerHelper_v1_13_R1 implements PlayerHelper {
    ...
    public ImprovedOfflinePlayer getOfflineData(UUID uuid) {
        return new ImprovedOfflinePlayer_v1_13_R1(uuid);
    }

    @Override
    public ImprovedOfflinePlayer getOfflineData(OfflinePlayer offlinePlayer) {
        return new ImprovedOfflinePlayer_v1_13_R1(offlinePlayer.getUniqueId());
    }

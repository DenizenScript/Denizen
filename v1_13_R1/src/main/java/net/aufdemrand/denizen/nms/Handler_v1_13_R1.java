...
import net.aufdemrand.denizen.nms.impl.BiomeNMS_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.ProfileEditor_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.Sidebar_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.blocks.BlockLight_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.jnbt.CompoundTag_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.packets.handlers.DenizenPacketListener_v1_13_R1;
...
public class Handler_v1_13_R1 extends NMSHandler {

    private final AnimationHelper animationHelper = new AnimationHelper_v1_13_R1();
    private final BlockHelper blockHelper = new BlockHelper_v1_13_R1();
    private final ChunkHelper chunkHelper = new ChunkHelper_v1_13_R1();
    private final CustomEntityHelper customEntityHelper = new CustomEntityHelper_v1_13_R1();
    private final EntityHelper entityHelper = new EntityHelper_v1_13_R1();
    private final FishingHelper fishingHelper = new FishingHelper_v1_13_R1();
    private final ItemHelper itemHelper = new ItemHelper_v1_13_R1();
    private final SoundHelper soundHelper = new SoundHelper_v1_13_R1();
    private final PacketHelper packetHelper = new PacketHelper_v1_13_R1();
    private final ParticleHelper particleHelper = new ParticleHelper_v1_13_R1();
    private final PlayerHelper playerHelper = new PlayerHelper_v1_13_R1();
    private final WorldHelper worldHelper = new WorldHelper_v1_13_R1();

    private final ProfileEditor profileEditor = new ProfileEditor_v1_13_R1();
    ...
    public void enablePacketInterception(PacketHandler packetHandler) {
        DenizenPacketListener_v1_13_R1.enable(packetHandler);
    }

    @Override
    public CompoundTag createCompoundTag(Map<String, Tag> value) {
        return new CompoundTag_v1_13_R1(value);
    }

    @Override
    public Sidebar createSidebar(Player player) {
        return new Sidebar_v1_13_R1(player);
    }

    @Override
    public BlockLight createBlockLight(Location location, int lightLevel, long ticks) {
        return BlockLight_v1_13_R1.createLight(location, lightLevel, ticks);
    }
        ...
        try {
            if (playerProfile != null) {
                ...
                if (Iterables.getFirst(gameProfile1.getProperties().get("textures"), null) == null) {
                    gameProfile1 = minecraftServer.ar().fillProfileProperties(gameProfile1, true);
                }
    ...
    @Override
    public int getPort() {
        return ((CraftServer) Bukkit.getServer()).getServer().H();
    }
    ...
    public BiomeNMS getBiomeNMS(Biome biome) {
        return new BiomeNMS_v1_13_R1(biome);
    }

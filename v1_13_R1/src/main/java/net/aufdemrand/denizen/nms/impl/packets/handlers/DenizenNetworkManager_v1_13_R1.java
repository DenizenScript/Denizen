...
import net.aufdemrand.denizen.nms.Handler_v1_13_R1;
import net.aufdemrand.denizen.nms.NMSHandler;
import net.aufdemrand.denizen.nms.impl.ProfileEditor_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.entities.EntityFakePlayer_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.packets.PacketOutChat_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.packets.PacketOutEntityMetadata_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.packets.PacketOutSetSlot_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.packets.PacketOutSpawnEntity_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.packets.PacketOutTradeList_v1_13_R1;
import net.aufdemrand.denizen.nms.impl.packets.PacketOutWindowItems_v1_13_R1;
...
public class DenizenNetworkManager_v1_13_R1 extends NetworkManager {

    private final NetworkManager oldManager;
    private final DenizenPacketListener_v1_13_R1 packetListener;
    private final EntityPlayer player;
    private final PacketHandler packetHandler;

    public DenizenNetworkManager_v1_13_R1(EntityPlayer entityPlayer, NetworkManager oldManager, PacketHandler packetHandler) {
        super(getProtocolDirection(oldManager));
        this.oldManager = oldManager;
        this.channel = oldManager.channel;
        this.packetListener = new DenizenPacketListener_v1_13_R1(this, entityPlayer);
    ...
    public static void setNetworkManager(Player player, PacketHandler packetHandler) {
        ...
        setNetworkManager(playerConnection, new DenizenNetworkManager_v1_13_R1(entityPlayer, playerConnection.networkManager, packetHandler));
    }
    ...
    public void sendPacket(Packet packet) {
        ...
        if (packet instanceof PacketPlayOutChat) {
            if (!packetHandler.sendPacket(player.getBukkitEntity(), new PacketOutChat_v1_13_R1((PacketPlayOutChat) packet))) {
            ...
            try {
                ...
                if (e == null) {
                    ...
                    if (!((Handler_v1_13_R1) NMSHandler.getInstance()).attachmentsA.containsKey(e.getUniqueID())
                            || ((Handler_v1_13_R1) NMSHandler.getInstance()).attachmentsA.get(e.getUniqueID()).equals(player.getUniqueID())) {
                        oldManager.sendPacket(packet);
                    }
                    UUID att = ((Handler_v1_13_R1) NMSHandler.getInstance()).attachments2.get(e.getUniqueID());
                    if (att != null) {
            ...
            PacketOutSpawnEntity spawnEntity = new PacketOutSpawnEntity_v1_13_R1(player, packet);
            ...
            if (entity == null) {
                ...
                if (entity instanceof EntityFakePlayer_v1_13_R1) {
                    final EntityFakePlayer_v1_13_R1 fakePlayer = (EntityFakePlayer_v1_13_R1) entity;
            ...
            ProfileEditor_v1_13_R1.updatePlayerProfiles(playerInfo);
            oldManager.sendPacket(playerInfo);
        }
        else if (packet instanceof PacketPlayOutEntityMetadata) {
            if (!packetHandler.sendPacket(player.getBukkitEntity(), new PacketOutEntityMetadata_v1_13_R1((PacketPlayOutEntityMetadata) packet))) {
                oldManager.sendPacket(packet);
            }
        }
        else if (packet instanceof PacketPlayOutSetSlot) {
            if (!packetHandler.sendPacket(player.getBukkitEntity(), new PacketOutSetSlot_v1_13_R1((PacketPlayOutSetSlot) packet))) {
                oldManager.sendPacket(packet);
            }
        }
        else if (packet instanceof PacketPlayOutWindowItems) {
            if (!packetHandler.sendPacket(player.getBukkitEntity(), new PacketOutWindowItems_v1_13_R1((PacketPlayOutWindowItems) packet))) {
                oldManager.sendPacket(packet);
            }
        }
            ...
            try {
                ...
                if (key != null && key.equals(PacketPlayOutCustomPayload.a)) { // MC|TrList -> minecraft:trader_list
                    if (!packetHandler.sendPacket(player.getBukkitEntity(), new PacketOutTradeList_v1_13_R1(payload, serializer))) {
                        oldManager.sendPacket(packet);
                    }
                }
                else {

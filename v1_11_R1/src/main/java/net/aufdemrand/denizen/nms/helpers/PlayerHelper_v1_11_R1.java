...
import net.aufdemrand.denizen.nms.impl.packets.handlers.AbstractListenerPlayIn_v1_11_R1;
...
public class PlayerHelper_v1_11_R1 extends PlayerHelper {
    ...
    public int getFlyKickCooldown(Player player) {
        ...
        if (conn instanceof AbstractListenerPlayIn_v1_11_R1) {
            conn = ((AbstractListenerPlayIn_v1_11_R1) conn).oldListener;
        }

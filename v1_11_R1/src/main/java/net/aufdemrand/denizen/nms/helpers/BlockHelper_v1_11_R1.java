...
public class BlockHelper_v1_11_R1 implements BlockHelper {
    ...
    private static net.minecraft.server.v1_11_R1.Block getBlockFrom(Material material) {
    ...
    public boolean setBlockResistance(Material material, float resistance) {
        net.minecraft.server.v1_11_R1.Block block = getBlockFrom(material);
        if (block == null) {
            return false;
        }
        ReflectionHelper.setFieldValue(net.minecraft.server.v1_11_R1.Block.class, "durability", block, resistance);
        return true;
    }
    ...
    public float getBlockResistance(Material material) {
        ...
        return ReflectionHelper.getFieldValue(net.minecraft.server.v1_11_R1.Block.class, "durability", block);
    }

...
public class EntityKnocksbackEntityScriptEvent extends BukkitScriptEvent implements Listener {
    ...
    // <context.cause> returns the cause of the entity getting knocked back. Causes list: <@link url https://jd.papermc.io/paper/1.21.1/io/papermc/paper/event/entity/EntityKnockbackEvent.Cause.html>
    //
    // @Determine

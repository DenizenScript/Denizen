...
import com.denizenscript.denizen.v1_13.helpers.PacketHelper_v1_13_R2;
import net.minecraft.server.v1_13_R2.*;
import org.bukkit.entity.Player;

public class Sidebar_v1_13_R2 extends Sidebar {
    ...
    public Sidebar_v1_13_R2(Player player) {
        super(player);
    ...
    public void sendUpdate() {
        PacketHelper_v1_13_R2.sendPacket(player, new PacketPlayOutScoreboardObjective(this.obj1, 0));
        for (int i = 0; i < this.lines.length; i++) {
            ...
            PacketHelper_v1_13_R2.sendPacket(player, new PacketPlayOutScoreboardScore(ScoreboardServer.Action.CHANGE, score.getObjective().getName(), score.getPlayerName(), score.getScore()));
        }
        PacketHelper_v1_13_R2.sendPacket(player, new PacketPlayOutScoreboardDisplayObjective(1, this.obj1));
        PacketHelper_v1_13_R2.sendPacket(player, new PacketPlayOutScoreboardObjective(this.obj2, 1));

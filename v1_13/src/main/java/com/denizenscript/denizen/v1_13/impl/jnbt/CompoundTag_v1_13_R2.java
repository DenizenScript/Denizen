package com.denizenscript.denizen.v1_13.impl.jnbt;
...
public class CompoundTag_v1_13_R2 extends CompoundTag {
     ...
     */
    public CompoundTag_v1_13_R2(Map<String, com.denizenscript.denizen.nms.util.jnbt.Tag> value) {
        super(value);
    }
    ...
    public NBTTagCompound toNMSTag() {
        ...
        for (Map.Entry<String, com.denizenscript.denizen.nms.util.jnbt.Tag> entry : value.entrySet()) {
            if (entry.getValue() instanceof IntTag) {
                ...
                tag.set(entry.getKey(), ((CompoundTag_v1_13_R2) entry.getValue()).toNMSTag());
            }
    ...
    public static CompoundTag fromNMSTag(NBTTagCompound tag) {
        ...
        return new CompoundTag_v1_13_R2(tags);
    }
}

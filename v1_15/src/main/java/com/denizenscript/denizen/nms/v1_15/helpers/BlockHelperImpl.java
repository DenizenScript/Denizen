...
public class BlockHelperImpl implements BlockHelper {
    ...
    public boolean setBlockResistance(Material material, float resistance) {
        ...
        ReflectionHelper.setFieldValue(net.minecraft.server.v1_15_R1.Block.class, "durability", block, resistance);
        return true;
    }
    ...
    public static final Field BLOCK_MATERIAL = ReflectionHelper.getFields(net.minecraft.server.v1_15_R1.Block.class).get("material");

    // private final EnumPistonReaction R;
    public static final MethodHandle MATERIAL_PUSH_REACTION_SETTER = ReflectionHelper.getFinalSetter(net.minecraft.server.v1_15_R1.Material.class, "R");
    ...
    public net.minecraft.server.v1_15_R1.Material getInternalMaterial(Material bukkitMaterial) {
        try {
            return (net.minecraft.server.v1_15_R1.Material) BLOCK_MATERIAL.get(getMaterialBlock(bukkitMaterial));
        }
        catch (Throwable ex) {
            Debug.echoError(ex);
            return null;

...
public class ChunkHelperImpl implements ChunkHelper {
    ...
    static {
        ...
        worldThreadField = ReflectionHelper.getFields(net.minecraft.server.v1_15_R1.World.class).get("serverThread");
        worldThreadFieldSetter = ReflectionHelper.getFinalSetter(net.minecraft.server.v1_15_R1.World.class, "serverThread");
    }

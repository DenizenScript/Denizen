...
public class ScriptEngine {
    ...
    public ScriptEngine(Denizen plugin) {
        this.plugin = plugin;
    }
    ...
    public void enforcePosition() {
        ...
        for (NPC theDenizen : DenizenNPCs) {
            if (!plugin.getSaves().contains("Denizens." + theDenizen.getName() + ".Position.Standing"))
                continue;
            if (plugin.getSaves().getString("Denizens." + theDenizen.getName() + ".Position.Standing").isEmpty()) continue;

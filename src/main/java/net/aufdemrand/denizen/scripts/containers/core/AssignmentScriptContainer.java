...
public abstract class AssignmentScriptContainer implements RegistrationableInstance {
    ...
    @Override
	public AssignmentScriptContainer activate() {
    ...
    @Override
	public AssignmentScriptContainer as(String requirementName) {
	...
	public AssignmentScriptContainer withOptions(String usageHint, int numberOfRequiredArgs) {

...
public abstract class TaskScriptContainer implements RegistrationableInstance {
    ...
    @Override
	public TaskScriptContainer activate() {
    ...
    @Override
	public TaskScriptContainer as(String requirementName) {
	...
	public TaskScriptContainer withOptions(String usageHint, int numberOfRequiredArgs) {

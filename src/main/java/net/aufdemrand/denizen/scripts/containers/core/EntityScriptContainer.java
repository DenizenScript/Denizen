...
public abstract class EntityScriptContainer implements RegistrationableInstance {
    ...
    @Override
	public EntityScriptContainer activate() {
    ...
    @Override
	public EntityScriptContainer as(String requirementName) {
	...
	public EntityScriptContainer withOptions(String usageHint, int numberOfRequiredArgs) {

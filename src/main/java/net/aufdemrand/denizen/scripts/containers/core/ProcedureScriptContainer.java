...
public abstract class ProcedureScriptContainer implements RegistrationableInstance {
    ...
    @Override
	public ProcedureScriptContainer activate() {
    ...
    @Override
	public ProcedureScriptContainer as(String requirementName) {
	...
	public ProcedureScriptContainer withOptions(String usageHint, int numberOfRequiredArgs) {

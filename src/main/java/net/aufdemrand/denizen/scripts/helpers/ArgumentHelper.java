...
public class ArgumentHelper {
	...
	public boolean matchesDuration(String regex) {
		Matcher m = durationPattern.matcher(regex.toLowerCase());
		return m.matches();
	}

	public boolean matchesQueueType(String regex) {
		Matcher m = queuetypePattern.matcher(regex.toLowerCase());
		return m.matches();
	}

	public boolean matchesScript(String regex) {
		Matcher m = scriptPattern.matcher(regex.toLowerCase());
	...
	public boolean matchesQuantity(String regex) {
		Matcher m = quantityPattern.matcher(regex.toLowerCase());
		return m.matches();
	}

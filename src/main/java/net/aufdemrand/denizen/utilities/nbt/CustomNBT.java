...
public class CustomNBT {
    ...
    public static boolean hasCustomNBT(ItemStack item, String key) {
        ...
        NBTTagCompound tag;
        net.minecraft.server.v1_7_R1.ItemStack cis = CraftItemStack.asNMSCopy(item);
    ...
    public static LivingEntity addCustomNBT(LivingEntity entity, String key, String value) {
        ...
        net.minecraft.server.v1_7_R1.Entity nmsEntity = ((CraftEntity) bukkitEntity).getHandle();

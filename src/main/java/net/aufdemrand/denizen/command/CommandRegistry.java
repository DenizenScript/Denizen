...
import net.aufdemrand.denizen.command.core.FlagCommand;
import net.aufdemrand.denizen.command.core.LookCommand;
import net.aufdemrand.denizen.command.core.ResetCommand;
